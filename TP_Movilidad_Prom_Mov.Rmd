...
El primer caso de COVID-19 en Argentina se detectó el 3 de marzo de 2020 y el 7 de marzo, el Ministerio de Salud confirmó la primera muerte causada por dicho virus. Pocos dias después, el 10 de marzo, la Organización Mundial de la Salud (OMS) declaró COVID-19 como pandemia. 
...
```{r}
# evitamos aparición de warnings y mensajes en el HTML
...
Los nuevos paquetes deberán ser agregados al vector "paquetes".
...
Como la URL de Apple se modifica día a día, usamos un mirror para descargar los datos.
...
Ademas, filtramos los datos, quedandonos únicamente con los correspondientes a los caminantes de Argentina, en donde sólo hay datos de CABA.
...
Ahora importamos y trabajamos sólo con aquellos de fallecidos por COVID-19 en Buenos Aires.
...
A partir del gráfico de movilidad y fallecimientos en función del tiempo se ve que la movilidad se condice con la implementación de las medidas del ASPO, ya que se observa una caída muy significativa en dicha tasa  en la fecha su de las medidas. Seguido a esto, el incremento de la movilidad es paulatino. 
  
En Noviembre de 2020, con la implementación de las medidas DISPO, se observa cómo aumenta de movilidad. A su vez, el comienzo de DISPO ocurre después de manifestarse una reducción en la cantidad de fallecidos. 
  
En Abril de 2021, fecha en la que se aplicaron por DNU nuevas restricciones a la movilidad, se identifica una reducción de la movilidad y los fallecimientos presentan una tendencia similar a la de Julio 2020.
